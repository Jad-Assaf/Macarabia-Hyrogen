                ...
                {images.length > 0 && (
                    <div className="product-slideshow" style={styles.slideshow}>
                        <motion.img
                            ...
                            srcSet={`${images[currentImageIndex]?.url}?width=300&quality=7.5 300w,
                                     ${images[currentImageIndex]?.url}?width=600&quality=7.5 600w,
                                     ${images[currentImageIndex]?.url}?width=1200&quality=7.5 1200w`}
                            width="180px"
                            height="180px"
                            loading="lazy"
                            style={styles.image}
