                    ...
                    <div className="footer-column">
                        ...
                        <ul className="contact-info">
                            <li>
                                ...
                                </svg></i> <a href="https://maps.app.goo.gl/wKNzrfSVrLm7srkB7" target="_blank" title="961 Souq Store Location">Macarabia - Zalka High Way Facing white Tower hotel Ground Floor, Zalka, Lebanon.</a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <a href="mailto:admin@961souq.com">admin@macarabia.me</a>
                            </li>
                        </ul>
                        {/* Social Media Links */}
