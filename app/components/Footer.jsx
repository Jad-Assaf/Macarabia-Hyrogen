                    ...
                    <div className="footer-column">
                        ...
                        <ul className="contact-info">
                            <li>
                                ...
                                </svg></i> <a href="https://maps.app.goo.gl/wKNzrfSVrLm7srkB7" target="_blank" title="Macarabia Store Location">Macarabia - Zalka High Way Facing white Tower hotel Ground Floor, Zalka, Lebanon.</a>
                            </li>
                            <li>
