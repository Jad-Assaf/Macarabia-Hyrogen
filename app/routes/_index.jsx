...
export default function Homepage() {
  ...
  const [isNewArrivalsInView, setIsNewArrivalsInView] = useState(false);
  ...
  return (
    <div className="home">
      ...
      {/* Render the rest of the sections only after New Arrivals is in view */}
      {isNewArrivalsInView && (
        <>
